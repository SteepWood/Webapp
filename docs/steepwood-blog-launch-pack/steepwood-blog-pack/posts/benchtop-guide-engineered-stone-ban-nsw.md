---
title: "Benchtop Buyer's Guide: After the Engineered Stone Ban"
slug: "benchtop-guide-engineered-stone-ban-nsw"
description: "The engineered stone ban changed everything from 1 July 2024. This NSW guide covers every legal benchtop alternative — sintered stone, porcelain, natural stone, laminate — with 2026 AU pricing."
date: "2026-06-22"
author: "Sukhveer Kaur"
category: "Materials"
tags: ["engineered stone alternatives Australia", "sintered stone benchtop", "benchtop options NSW 2026", "Dekton Neolith Australia", "stone benchtop ban"]
readingTime: "11 min read"
hero:
  src: "/blog/benchtop-guide-engineered-stone-ban-nsw/hero.jpg"
  alt: "Sintered stone benchtop in a custom kitchen joinery Newcastle NSW — Dekton slab with dark timber cabinetry"
ogImage: "/blog/benchtop-guide-engineered-stone-ban-nsw/og.jpg"
primaryKeyword: "engineered stone alternatives Australia"
...
[Safe Work Australia confirms the prohibition](https://www.safeworkaustralia.gov.au/safety-topic/hazards/crystalline-silica-and-silicosis/prohibition-engineered-stone) under the model Work Health and Safety Regulations: from 1 July 2024, the manufacture, supply, processing, and installation of engineered stone containing 1% or more crystalline silica by weight is banned in all Australian jurisdictions that have adopted the model WHS framework. The [Australian Construction Association confirmed the 1 July 2024 commencement date](https://aca.org.au/engineered-stone-prohibition-from-1-july-2024), and there is no active legislative pathway to reverse it.
...
| Material | Cost/lm (installed) | Silica content | Heat resistance | Stain resistance | Scratch resistance | Maintenance | Aesthetic range |
|---|---|---|---|---|---|---|---|
| **Laminate** | $250–$550 | Nil | Low — surfaces scorch | Good if sealed edge | Low | Low — wipe clean | Wide — stone, timber, solid colour looks |
| **Timber** | $400–$1,200 | Nil | Low — marks and chars | Moderate with sealing | Low–moderate | High — annual oiling/sealing | Warm, natural; suits traditional and Hamptons styles |
| **Solid surface (Corian)** | $700–$1,400 | Nil | Moderate | Very good | Moderate | Low — scratches can be sanded out | Seamless joins; matte and mineral looks |
| **Stainless steel** | $900–$1,500 | Nil | Excellent | Very good | Moderate — scratches but dulls evenly | Low — wipe clean | Industrial and contemporary |
| **Porcelain slab** | $900–$1,800 | Low | Excellent | Excellent | Very good | Very low — no sealing required | Stone-look, concrete-look, marble-look |
...
All three brands offer outdoor-rated products — important for entertaining areas, outdoor kitchens, and commercial applications, where UV stability and frost resistance are relevant. For [commercial joinery fitouts](/commercial-joinery) in NSW, sintered stone is now the go-to hard-surface specification where budget permits.
...
For coastal Newcastle homes, exercise caution with marble in high-humidity environments — the material absorbs moisture and persistent dampness accelerates surface degradation. Granite or sintered stone is a more resilient specification for salt-air environments near [Newcastle](/locations/newcastle) and the Central Coast.
...
**Maximum (by Porcelanosa Group):** Large-format porcelain tiles and slabs available through Porcelanosa retailers, including in [Sydney](/locations/sydney). Common in commercial and residential kitchen specifications. Strong marble-look and concrete series.
...
Porcelain slab installed pricing: $900–$1,800/lm. For clients wanting a premium stone look at a step below sintered stone pricing, it is a sensible specification. It also pairs well with our [custom bathroom vanity](/custom-bathroom-vanity) work — the same benchtop logic applies to vanity tops, and porcelain slab handles bathroom humidity without any concern.
...
> **STEEPWOOD SERVICE** — SteepWood designs and builds [custom kitchen joinery](/custom-kitchen-joinery) from our Newcastle workshop, hand-crafted in Australian-sourced timber where possible, with a 10-year structural warranty. We work with your stonemason of choice or can refer you to WHS-compliant suppliers in the Newcastle and Sydney regions. [Get a free measure and quote](/quote) — we cover all NSW and ACT, with free in-home measure and quote. NSW Carpentry Contractor Licence 489553C.
...
Our dedicated post on [questions to ask your joiner](/blog/questions-to-ask-custom-joiner-australia) covers this in more detail across the full scope of a custom joinery project.
...
### What is the cheapest legal alternative to engineered stone in Australia?
...
No. The prohibition under Australian WHS law covers manufacture, supply, and installation. A licensed stonemason cannot install prohibited engineered stone even if it was purchased before 1 July 2024. There were short transitional provisions for contracts entered into before the ban in some states, but those windows have now closed. If you have unused engineered stone slab in storage, consult a WHS adviser about compliant disposal. [Safe Work Australia's guidance](https://www.safeworkaustralia.gov.au/safety-topic/hazards/crystalline-silica-and-silicosis/prohibition-engineered-stone) is the authoritative source on this point.
