...
const PARAGRAPHS = [
  ...
  "Whether you are renovating a single bathroom vanity or commissioning a whole-home kitchen and wardrobe package, the same team follows your project from first sketch to final adjustment on site. That continuity is what clients notice most — one workshop, one standard, one point of accountability.",
] as const;
